...
// ---------------------------------------------------------------------------
#ifndef SSD1308_I2C_h
#define SSD1308_I2C_h

#include <inttypes.h>
#include "PortExpander/PortExpanderPCA9557.hpp"

#include "I2CIO.h"
#include "LCD.h"


class SSD1308_I2C : public LCD 
{
public:
    ...
    */
   explicit SSD1308_I2C (uint8_t lcd_Addr);
   // Constructor with backlight control
   SSD1308_I2C (uint8_t lcd_Addr, uint8_t backlighPin, t_backlighPol pol);
    ...
    */
   SSD1308_I2C( uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs);
   // Constructor with backlight control
   SSD1308_I2C(uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs,
   ...
   /*!
    ...
    @param      d6[in] LCD data 2 pin map on IO extender module
    @param      d7[in] LCD data 3 pin map on IO extender module
	@param      backlighPin[in] Backlight PIN
    @param      pol[in] Backlicht polarity
    */					 // Constructor with backlight control
   SSD1308_I2C(uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs, 
                     uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7,
                     uint8_t backlighPin, t_backlighPol pol);
...
private:
   ...
   PortExpanderPCA9557   _i2cio;            // I2CIO PCF8574* expansion module driver I2CLCDextraIO
