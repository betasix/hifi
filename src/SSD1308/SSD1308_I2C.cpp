...
// Changed by  Dieter Zumkehr on 01/07/16
...
// 
// @brief 
// This is a basic implementation of the SSD1308 library of the
// Arduino SDK. The original library has been reworked in such a way that 
// this class implements the all methods to command an LCD based
// on the Solomon SSD1308 and compatible chipsets using I2C extension
// backpacks such as the I2CLCDextraIO with the PCF8574* I2C IO Expander ASIC.
//
// The functionality provided by this class and its base class is identical
// to the original functionality of the Arduino SSD1308 library.
//
//
//
...
// CONSTRUCTORS
// ---------------------------------------------------------------------------
SSD1308_I2C::SSD1308_I2C( uint8_t lcd_Addr )
{
   config(lcd_Addr, EN, RW, RS, D4, D5, D6, D7);
}


SSD1308_I2C::SSD1308_I2C(uint8_t lcd_Addr, uint8_t backlighPin, 
...
SSD1308_I2C::SSD1308_I2C(uint8_t lcd_Addr, uint8_t En, uint8_t Rw,
                                     uint8_t Rs)
{
   config(lcd_Addr, En, Rw, Rs, D4, D5, D6, D7);
}
...
//
// begin
void SSD1308_I2C::begin(uint8_t cols, uint8_t lines, uint8_t dotsize) 
{
...
//
// setBacklightPin
void SSD1308_I2C::setBacklightPin ( uint8_t value, t_backlighPol pol = POSITIVE )
{
...
//
// setBacklight
void SSD1308_I2C::setBacklight( uint8_t value ) 
{
...
//
// config
void SSD1308_I2C::config (uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs, 
...
void SSD1308_I2C::send(uint8_t value, uint8_t mode) 
{
   ...
   {
	  // For the new display we need to write address then
	  // output register address then then the data
      write4bits( (value >> 4), mode );  // high nibble
      write4bits( (value & 0x0F), mode); // low nibble
   }
}

//
// write4bits
void SSD1308_I2C::write4bits ( uint8_t value, uint8_t mode ) 
{
...
//
// pulseEnable
void SSD1308_I2C::pulseEnable (uint8_t data)
{
	uint8_t data1 = (data | _En);
	uint8_t data2 = (data & ~_En);
